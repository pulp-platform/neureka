...
package neureka_package;
  ...
  typedef enum {
    IDLE, STREAMIN, LOAD, WEIGHTOFFS, MATRIXVEC, NORMQUANT, NORMQUANT_BIAS, NORMQUANT_SHIFT, OUTCHECK, ERROR, STREAMOUT, STREAMOUT_DONE, UPDATEIDX, UPDATEIDX_WAIT, DONE, TMR_ERROR
  } state_neureka_t;
  ...
  // redundancy-mode uloop microcodes, generated by ucode/uloop_compile_redun.py
  ...
  parameter logic[351:0] ULOOP_CODE_NORMAL_LCS     = 352'h04748a101228c2c8a50b627c2a8a30b22742904208410821;
  parameter logic[53:0]  ULOOP_LOOPS_NORMAL_LCS    = 54'b010100111001100100000100100000000010;
  parameter logic[351:0] ULOOP_CODE_AUX            = 352'h0212402;
  parameter logic[53:0]  ULOOP_LOOPS_AUX           = 54'b000000010;
  // performance-mode uloop microcode, generated by ucode/uloop_compile_perf.py
  parameter logic[351:0] ULOOP_CODE_NORMAL_PERF     = 352'h011d22840485701e28c2c8a50b627c2a85701e28c2c89d13a14c2985701e14405;
  parameter logic[53:0]  ULOOP_LOOPS_NORMAL_PERF    = 54'b011101001010000110000100110000000010;
  // redundancy-mode depthwise uloop microcode, generated by ucode/uloop_compile_dw.py
  ...
  // performance-mode depthwise uloop microcode, generated by ucode/uloop_compile_dw_perf.py
  parameter logic[351:0] ULOOP_CODE_DEPTHWISE_PERF  = 352'h0108218e90a2284048a30b22942d89f0aa28c2c89d13a14c29;
  parameter logic[53:0]  ULOOP_LOOPS_DEPTHWISE_PERF = 54'b0100000010010001000001000100000000100;
