...
package neureka_package;
  ...
  typedef enum {
    IDLE, STREAMIN, LOAD, WEIGHTOFFS, MATRIXVEC, NORMQUANT, NORMQUANT_BIAS, NORMQUANT_SHIFT, DMR_DELAY_WAIT, OUTCHECK, ERROR, STREAMOUT, STREAMOUT_DONE, UPDATEIDX, UPDATEIDX_WAIT, DONE
  } state_neureka_t;
  ...
  // performance-mode uloop microcodes, generated by ucode/uloop_compile_perf.py
  parameter logic[351:0] ULOOP_CODE_NORMAL_PERF_D0     = 352'h011d22840489d0a615c078a30b22942d89f0aa2742985701e28c2c89d13a14c2985701e14405;
  parameter logic[53:0]  ULOOP_LOOPS_NORMAL_PERF_D0    = 54'b100001011010001000000100110000000010;
  parameter logic[351:0] ULOOP_CODE_NORMAL_PERF_D1     = 352'h04748a10122742985701e28c2c8a50b627c2a89d0a615c078a30b22744e8530a615c0785101627429;
  parameter logic[53:0]  ULOOP_LOOPS_NORMAL_PERF_D1    = 54'b100101011010101000001000110000100010000000010;
