...
#              Neureka testbench, so they can be used in the fault injection script
...
# set ::inject_register_netlist [list {*}[get_neureka_registers]]

set ::netlist_ignore [list {*}$::core_netlist_ignore]
lappend netlist_ignore *_q
...
proc fault_injection_test_signals {} {
  set intc_list [list]
  lappend intc_list \
    "tb_neureka/i_dut/i_neureka_top/i_engine/ft_datapath_gen/redundancy_gen\[0\]/i_double_infeat_buffer/i_even_infeat_buffer/i_infeat_buffer_scm/neureka_infeat_buffer_scm_i/buffer\[0\]" \
    "tb_neureka/i_dut/i_neureka_top/i_engine/ft_datapath_gen/redundancy_gen\[0\]/i_double_infeat_buffer/i_even_infeat_buffer/i_infeat_buffer_scm/neureka_infeat_buffer_scm_i/buffer\[1\]"
  return $intc_list
}
